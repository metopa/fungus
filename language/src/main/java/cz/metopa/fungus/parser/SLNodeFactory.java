...
import cz.metopa.fungus.nodes.controlflow.SLBreakNode;
import cz.metopa.fungus.nodes.controlflow.SLDebuggerNode;
import cz.metopa.fungus.nodes.controlflow.SLIfNode;
import cz.metopa.fungus.nodes.controlflow.SLWhileNode;
import cz.metopa.fungus.nodes.expression.SLBigIntegerLiteralNode;
import cz.metopa.fungus.nodes.expression.SLFunctionLiteralNode;
import cz.metopa.fungus.nodes.expression.SLInvokeNode;
import cz.metopa.fungus.nodes.expression.SLLogicalAndNode;
import cz.metopa.fungus.nodes.expression.SLLogicalOrNode;
import cz.metopa.fungus.nodes.expression.SLLongLiteralNode;
import cz.metopa.fungus.nodes.expression.SLParenExpressionNode;
import cz.metopa.fungus.nodes.expression.SLReadPropertyNode;
import cz.metopa.fungus.nodes.expression.SLStringLiteralNode;
import cz.metopa.fungus.nodes.expression.SLWritePropertyNode;
import cz.metopa.fungus.nodes.local.SLReadArgumentNode;
...
import cz.metopa.fungus.nodes.controlflow.SLBlockNode;
import cz.metopa.fungus.nodes.controlflow.SLContinueNode;
import cz.metopa.fungus.nodes.controlflow.SLFunctionBodyNode;
import cz.metopa.fungus.nodes.controlflow.SLReturnNode;
import cz.metopa.fungus.nodes.expression.SLAddNodeGen;
import cz.metopa.fungus.nodes.expression.SLDivNodeGen;
import cz.metopa.fungus.nodes.expression.SLEqualNodeGen;
import cz.metopa.fungus.nodes.expression.SLLessOrEqualNodeGen;
import cz.metopa.fungus.nodes.expression.SLLessThanNodeGen;
import cz.metopa.fungus.nodes.expression.SLLogicalNotNodeGen;
import cz.metopa.fungus.nodes.expression.SLMulNodeGen;
import cz.metopa.fungus.nodes.expression.SLReadPropertyNodeGen;
import cz.metopa.fungus.nodes.expression.SLSubNodeGen;
import cz.metopa.fungus.nodes.expression.SLWritePropertyNodeGen;
import cz.metopa.fungus.nodes.local.SLReadLocalVariableNodeGen;
import cz.metopa.fungus.nodes.local.SLWriteLocalVariableNodeGen;
import cz.metopa.fungus.nodes.util.SLUnboxNodeGen;
