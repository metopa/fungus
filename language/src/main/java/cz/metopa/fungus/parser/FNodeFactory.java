...
public class FNodeFactory {
  ...
  public SLExpressionNode createCall(String funcName, List<SLExpressionNode> arguments,
                                     int startIndex, int stopIndex) {
    ...
    final SLExpressionNode result = new SLInvokeNode(funcNode,
        arguments.toArray(new SLExpressionNode[0]));
