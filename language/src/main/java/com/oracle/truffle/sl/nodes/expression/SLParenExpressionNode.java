...
/**
 * A {@link SLExpressionNode} that represents a parenthesized expression; it
...
public class SLParenExpressionNode extends SLExpressionNode {
    ...
    public SLParenExpressionNode(SLExpressionNode expression) { this.expression = expression; }
