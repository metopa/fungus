...
public class SimpleLanguageParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7,
                            ...
                            T__25 = 26, T__26 = 27, T__27 = 28, T__28 = 29, T__29 = 30, WS = 31,
                            COMMENT = 32, LINE_COMMENT = 33, IDENTIFIER = 34, STRING_LITERAL = 35,
                            NUMERIC_LITERAL = 36;
    public static final int RULE_simplelanguage = 0, RULE_function = 1, RULE_block = 2,
                            RULE_statement = 3, RULE_while_statement = 4, RULE_if_statement = 5,
                            RULE_return_statement = 6, RULE_expression = 7, RULE_logic_term = 8,
                            RULE_logic_factor = 9, RULE_arithmetic = 10, RULE_term = 11,
                            RULE_factor = 12, RULE_member_expression = 13;
    public static final String[] ruleNames = {
        "simplelanguage",   "function",         "block",
        "statement",        "while_statement",  "if_statement",
        "return_statement", "expression",       "logic_term",
        "logic_factor",     "arithmetic",       "term",
    ...
    private static final class BailoutErrorListener extends BaseErrorListener {
        ...
        BailoutErrorListener(Source source) { this.source = source; }
    ...
    private static void throwParseError(Source source, int line, int charPositionInLine,
                                        Token token, String message) {
        int col = charPositionInLine + 1;
        String location = "-- line " + line + " col " + col + ": ";
        int length = token == null ? 1 : Math.max(token.getStopIndex() - token.getStartIndex(), 0);
        throw new SLParseError(source, line, col, length,
    ...
    public static class SimplelanguageContext extends ParserRuleContext {
        public List<FunctionContext> function() { return getRuleContexts(FunctionContext.class); }

        public FunctionContext function(int i) { return getRuleContext(FunctionContext.class, i); }
    ...
    public static class FunctionContext extends ParserRuleContext {
        ...
        public BlockContext block() { return getRuleContext(BlockContext.class, 0); }
    ...
    public final BlockContext block(boolean inLoop) throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                while ((((_la) & ~0x3f) == 0 &&
                        ((1L << _la) &
                         ((1L << T__1) | (1L << T__6) | (1L << T__8) | (1L << T__9) |
                          (1L << T__10) | (1L << T__11) | (1L << T__13) | (1L << IDENTIFIER) |
                          (1L << STRING_LITERAL) | (1L << NUMERIC_LITERAL))) != 0)) {
                    {
                        {
                            setState(59);
                ...
                _localctx.result = factory.finishBlock(body, _localctx.s.getStartIndex(),
                                                       _localctx.e.getStopIndex() -
                                                           _localctx.s.getStartIndex() + 1);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final While_statementContext while_statement() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _localctx.result = factory.createWhile(_localctx.w, _localctx.condition.result,
                                                       _localctx.body.result);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class If_statementContext extends ParserRuleContext {
        ...
        public List<BlockContext> block() { return getRuleContexts(BlockContext.class); }

        public BlockContext block(int i) { return getRuleContext(BlockContext.class, i); }
    ...
    public final If_statementContext if_statement(boolean inLoop) throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _localctx.result = factory.createIf(_localctx.i, _localctx.condition.result,
                                                    _localctx.then.result, elsePart);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final Return_statementContext return_statement() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _la = _input.LA(1);
                if ((((_la) & ~0x3f) == 0 &&
                     ((1L << _la) & ((1L << T__1) | (1L << IDENTIFIER) | (1L << STRING_LITERAL) |
                                     (1L << NUMERIC_LITERAL))) != 0)) {
                    {
                        setState(117);
                        _localctx.expression = expression();
                        ...
                        {
                            {
                                ...
                                setState(128);
                                _localctx.logic_term = logic_term();
                                _localctx.result = factory.createBinary(
                                    _localctx.op, _localctx.result, _localctx.logic_term.result);
                            }
                        }
                    }
                    setState(135);
                        ...
                        {
                            {
                                ...
                                _localctx.logic_factor = logic_factor();
                                _localctx.result = factory.createBinary(
                                    _localctx.op, _localctx.result, _localctx.logic_factor.result);
                            }
                        }
                    }
                    setState(146);
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                case 1: {
                    ...
                    _la = _input.LA(1);
                    if (!((((_la) & ~0x3f) == 0 &&
                           ((1L << _la) & ((1L << T__16) | (1L << T__17) | (1L << T__18) |
    ...
    public static class ArithmeticContext extends ParserRuleContext {
        ...
        public List<TermContext> term() { return getRuleContexts(TermContext.class); }

        public TermContext term(int i) { return getRuleContext(TermContext.class, i); }
                        ...
                        {
                            {
                                ...
                                _localctx.term = term();
                                _localctx.result = factory.createBinary(
                                    _localctx.op, _localctx.result, _localctx.term.result);
                            }
                        }
                    }
                    setState(165);
    ...
    public static class TermContext extends ParserRuleContext {
        ...
        public List<FactorContext> factor() { return getRuleContexts(FactorContext.class); }

        public FactorContext factor(int i) { return getRuleContext(FactorContext.class, i); }
                        ...
                        {
                            {
                                ...
                                _localctx.factor = factor();
                                _localctx.result = factory.createBinary(
                                    _localctx.op, _localctx.result, _localctx.factor.result);
                            }
                        }
                    }
                    setState(176);
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                case IDENTIFIER: {
                    ...
                    SLExpressionNode assignmentName =
                        factory.createStringLiteral(_localctx.IDENTIFIER, false);
                    setState(183);
                    _errHandler.sync(this);
                ...
                case T__1: {
                    ...
                    _localctx.result = factory.createParenExpression(
                        _localctx.expr.result, _localctx.s.getStartIndex(),
                        _localctx.e.getStopIndex() - _localctx.s.getStartIndex() + 1);
                } break;
                default:
                    throw new NoViableAltException(this);
                }
    ...
    public static class Member_expressionContext extends ParserRuleContext {
        ...
        public Member_expressionContext(ParserRuleContext parent, int invokingState,
                                        SLExpressionNode r, SLExpressionNode assignmentReceiver,
                                        SLExpressionNode assignmentName) {
            super(parent, invokingState);
            this.r = r;
    ...
    public final Member_expressionContext member_expression(SLExpressionNode r,
                                                            SLExpressionNode assignmentReceiver,
                                                            SLExpressionNode assignmentName)
        throws RecognitionException {
        Member_expressionContext _localctx =
            new Member_expressionContext(_ctx, getState(), r, assignmentReceiver, assignmentName);
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                case T__26: {
                    ...
                    if (assignmentName == null) {
                        SemErr((_localctx.expression != null ? (_localctx.expression.start) : null),
                               "invalid "
                                   + "assignment target");
                    } else if (assignmentReceiver == null) {
                        _localctx.result =
                            factory.createAssignment(assignmentName, _localctx.expression.result);
                    } else {
                        _localctx.result = factory.createWriteProperty(
                            assignmentReceiver, assignmentName, _localctx.expression.result);
                    }
                } break;
                case T__27: {
                    setState(218);
                ...
                case 1: {
                    setState(230);
                    _localctx.member_expression =
                        member_expression(_localctx.result, receiver, nestedAssignmentName);
                    _localctx.result = _localctx.member_expression.result;
                } break;
                }
            }
    ...
    public static final String _serializedATN =
        ...
        + "\13\4\f\t\f\4\r\t\r\4"
        + "\16\t\16\4\17\t\17\3\2\3\2\7\2!\n\2\f\2\16\2$\13"
        + "\2\3\2\3\2\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\7\3"
        + "\61\n\3\f\3\16\3\64"
        + "\13\3\5\3\66\n\3\3\3\3\3\3\3\3\3\3\4\3\4\3\4\3\4\3\4\7\4A\n\4\f\4\16\4"
        + "D\13"
        + "\4\3\4\3\4\3\4\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5"
        ...
        + "\3\17\3"
        + "\17\3\17\3\17\3\17\3\17\3\17\3\17\3\17\5\17\u00e7\n\17\3\17\3\17"
        + "\3\17\5\17\u00ec\n\17\3\17\2\2\20\2"
        + "\4\6\b\n\f\16\20\22\24\26\30\32\34"
        + "\2\5\3\2\23\30\3\2\31\32\3\2\33\34\2\u00fa\2\36\3\2\2\2\4\'\3\2\2"
        + "\2\6"
        + ";\3\2\2\2\b^\3\2\2\2\n`\3\2\2\2\fg\3\2\2\2\16u\3\2\2\2\20\177\3\2\2\2"
        + "\22\u008a\3\2\2\2\24"
        + "\u0095\3\2\2\2\26\u009d\3\2\2\2\30\u00a8\3\2\2\2\32"
        + "\u00c4\3\2\2\2\34\u00c6\3\2\2\2\36\"\5\4\3\2\37"
        + "!\5\4\3\2 \37\3\2\2\2!"
        + "$\3\2\2\2\" \3\2\2\2\"#\3\2\2\2#%\3\2\2\2$\"\3\2\2\2%&\7\2\2\3&\3\3\2"
        + "\2"
        + "\2\'(\7\3\2\2()\7$\2\2)*\7\4\2\2*\65\b\3\1\2+,\7$\2\2,\62\b\3\1\2-."
        + "\7\5\2\2./\7$\2\2/\61\b\3\1\2\60"
        + "-\3\2\2\2\61\64\3\2\2\2\62\60\3\2\2\2"
        + "\62\63\3\2\2\2\63\66\3\2\2\2\64\62\3\2\2\2\65+\3\2\2\2\65\66\3"
        + "\2\2\2\66"
        + "\67\3\2\2\2\678\7\6\2\289\5\6\4\29:\b\3\1\2:\5\3\2\2\2;<\b\4\1\2<B\7\7"
        + "\2\2=>\5\b\5\2"
        + ">?\b\4\1\2?A\3\2\2\2@=\3\2\2\2AD\3\2\2\2B@\3\2\2\2BC\3\2"
        + "\2\2CE\3\2\2\2DB\3\2\2\2EF\7\b\2\2FG\b\4\1"
        + "\2G\7\3\2\2\2HI\5\n\6\2IJ\b"
