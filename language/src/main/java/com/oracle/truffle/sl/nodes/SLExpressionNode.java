...
public abstract class SLExpressionNode extends SLStatementNode {
     ...
     * statement} is already sufficient, the return value is just discarded.
     */
    @Override
     ...
     */
    public final void addExpressionTag() { hasExpressionTag = true; }

    /*
     * Execute methods for specialized types. They all follow the same pattern:
     * they call the generic execution method and then expect a result of their
     * return type. Type-specialized subclasses overwrite the appropriate methods.
     */
