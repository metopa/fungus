 ...
 * {@link NodeChild} that defines the function arguments.<br> The builtin
 * functions are registered in {@link SLContext#installBuiltins}. Every builtin
 * node subclass is instantiated there, wrapped into a function, and added to
 * the
 * {@link SLFunctionRegistry}. This ensures that builtin functions can be called
 * like user-defined functions; there is no special function lookup or call node
