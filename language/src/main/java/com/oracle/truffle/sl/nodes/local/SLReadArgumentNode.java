 ...
 * arguments are loaded into local variables {@link
...
public class SLReadArgumentNode extends SLExpressionNode {
    ...
    public SLReadArgumentNode(int index) { this.index = index; }
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        if (index < args.length) {
            ...
            /* In the interpreter, record profiling information that the branch was
             * used. */
