...
public abstract class SLWriteLocalVariableNode extends SLExpressionNode {
    ...
    /**
     * Specialized method to write a primitive {@code long} value. This is only
     * possible if the local variable also has currently the type {@code long} or
     * was never written before, therefore a Truffle DSL {@link
     * #isLongOrIllegal(VirtualFrame) custom guard} is specified.
     */
     ...
     * <p>
     * Why is this method annotated with {@link Specialization} and not {@link
     * Fallback}? For a
     * {@link Fallback} method, the Truffle DSL generated code would try all other
     * specializations first before calling this method. We know that all these
     * specializations would fail their guards, so there is no point in calling
     * them. Since this method takes a value of type
    ...
    protected Object write(VirtualFrame frame, Object value) {
        /*
         * Regardless of the type before, the new and final type of the local
         * variable is Object. Changing the slot kind also discards compiled code,
         * because the variable type is important when the compiler optimizes a
         * method.
         *
