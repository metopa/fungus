...
/**
 * Exception thrown by the {@link SLContinueNode continue statement} and caught
 * by the
 * {@link SLWhileNode loop statement}. Since the exception is stateless, i.e.,
 * has no instance fields, we can use a {@link #SINGLETON} to avoid memory
